...
| [D009](D009.md) | `METHOD.md` §5.5 (new, 2026-09-08); D008's frozen selection chains; human decision to pause Phase 3 pending this validation | **OPEN** 2026-09-08 — closed-set accuracy under the paper's own trained pipeline (fair comparison across D008's four query strategies) | REVIEW (not yet planned) | D008 (CLOSED) | `results/D009/`, `D009.md` `## R` |
