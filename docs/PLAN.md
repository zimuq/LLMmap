...
| [D006](D006.md) | TODO.md Phase 1 (T1.1–T1.4) + D002 §R4 + D003 + D005; A1/C4 decided 2026-09-05 | **OPEN** — P1 posted 2026-09-05, mostly approved same day (F2–F6, Call 1, Call 2) — TACC clear to run S1+S2 now; **S3–S8 wait on F1 (C7 ceiling), held for the human** | REVIEW (P1 partially approved) | none — A1 (✅ 37 models), C3 (✅ ~250, 233 delivered), C4 (✅ 75/25/25), D005 (✅ I2 holds) all satisfied | `docs/plans/D006-P1.md`; `## R` pending |
