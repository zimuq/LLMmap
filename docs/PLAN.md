...
| [D006](D006.md) | TODO.md Phase 1 (T1.1–T1.4) + D002 §R4 + D003 + D005; A1/C4 decided 2026-09-05 | **OPEN** — drafted 2026-09-05, awaiting a P | REVIEW | none — A1 (✅ 37 models), C3 (✅ ~250, 233 delivered), C4 (✅ 75/25/25), D005 (✅ I2 holds) all satisfied | `D006.md` `## P`/`## R` pending |
...
- TACC executes only `status: OPEN` D's whose `gate` is satisfied — `AUTO`
  ...
  verdict. D006 has no posted Review yet — TACC should write P1 first, per
  the standard flow.
